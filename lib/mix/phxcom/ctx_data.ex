defmodule Mix.Phxcom.CtxData do
  @moduledoc false
  ...
  #   basename  = Phoenix.Naming.underscore(blueprint_name)
  #   module    = Module.concat([base, blueprint_name])
  #   repo      = opts[:repo] || Module.concat([base, "Repo"])
  #   file      = Mix.Phoenix.context_lib_path(ctx_app, basename <> ".ex")
  #   table     = opts[:table] || blueprint_plural
  ...
  #   generate? = Keyword.get(opts, :blueprint, true)
  #
  #   singular =
  #     module
  #     |> Module.split()
  ...
  #     file: file,
  #     attrs: attrs,
  #     plural: blueprint_plural,
  #     singular: singular,
  #     assocs: assocs,
  #     types: types,
  #     defaults: blueprint_defaults(attrs),
  #     uniques: uniques,
  #     indexes: indexes(table, assocs, uniques),
  #     human_singular: Phoenix.Naming.humanize(singular),
  #     human_plural: Phoenix.Naming.humanize(blueprint_plural),
  ...
  # @doc """
  # Returns the string value of the default blueprint param.
  # """
  # def default_param(%Blueprint{} = blueprint, action) do
  #   blueprint.params
  #   |> Map.fetch!(action)
  #   |> Map.fetch!(blueprint.params.default_key)
  #   |> to_string()
  # end
  ...
  # """
  # def value(blueprint, field, value) do
  #   blueprint.types
  #   |> Map.fetch!(field)
  #   |> inspect_value(value)
  # end
  ...
  #   For example:
  #
  #       mix phx.gen.blueprint Post posts settings:array:string
  #   """
  # end
  ...
  # defp partition_attrs_and_assocs(blueprint_module, attrs) do
  #   {assocs, attrs} =
  ...
  #         For example:
  #
  #             mix phx.gen.blueprint Comment comments body:text post_id:references:posts
  #         """
  #       _ -> false
  #     end)
  #
  ...
  #       base = blueprint_module |> Module.split() |> Enum.drop(-1)
  ...
  # defp blueprint_defaults(attrs) do
  #   Enum.into(attrs, %{}, fn
  ...
  # defp types(attrs) do
  #   Enum.into(attrs, %{}, fn
  #     {key, {root, val}} -> {key, {root, blueprint_type(val)}}
  #     {key, val} -> {key, blueprint_type(val)}
  #   end)
  # end

  # defp blueprint_type(:text), do: :string
  # defp blueprint_type(:uuid), do: Ecto.UUID
  # defp blueprint_type(val) do

defmodule Mix.Tasks.Phxcom.Gen.Context do
  @shortdoc "Generate a Commanded context"
  ...
  The Commanded context is an Elixir module that serves as an API boundary for
  the given resource. 

  The Commanded context will contain a list of elements
  ...
  def run(args) do
    if Mix.Project.umbrella? do
      Mix.raise "mix phxcom.gen.context can only be run inside an application directory"
    end
